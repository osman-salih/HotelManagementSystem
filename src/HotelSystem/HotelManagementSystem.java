...
public interface HotelManagementSystem {
     ...
     */
    public void bookingRoom(Room newRoom,Hotel hotelOb,String filename) throws IOException;
     ...
     * @throws IOException  exception that readData or writeData methods throws
     */
    int osmanBooking(Room deleteRoom, Hotel hotelOb, int roomId, String filename) throws IOException;
