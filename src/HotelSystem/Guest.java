...
public class Guest implements HotelManagementSystem {
     ...
     */
    @Override
    public int osmanBooking(Room deleteRoom, Hotel hotelOb, int roomId, String filename) {
        int i = 0, equal = -1;
        try {
            readData(hotelOb,filename);
        } catch (IOException e) {
        ...
        System.out.println("There is no room reservation that you want to osman");
        return -1;
    }
}
